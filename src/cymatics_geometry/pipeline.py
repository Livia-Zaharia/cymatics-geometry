...
def _shape_params_from_config(
    ...
    *,
    ...
    return ShapeParams(
        ...
        teardrop_height=float(config.teardrop_height),
        teardrop_radius_0=float(config.teardrop_radius_0),
        teardrop_radius_1=float(config.teardrop_radius_1),
        teardrop_radius_2=float(config.teardrop_radius_2),
        teardrop_radius_3=float(config.teardrop_radius_3),
        teardrop_radius_4=float(config.teardrop_radius_4),
        teardrop_station_1=float(config.teardrop_station_1),
        teardrop_station_2=float(config.teardrop_station_2),
        teardrop_station_3=float(config.teardrop_station_3),
        ...
        bead_height=float(config.bead_height),
        bead_radius_0=float(config.bead_radius_0),
        bead_radius_1=float(config.bead_radius_1),
        bead_radius_2=float(config.bead_radius_2),
        bead_radius_3=float(config.bead_radius_3),
        bead_radius_4=float(config.bead_radius_4),
        bead_station_1=float(config.bead_station_1),
        bead_station_2=float(config.bead_station_2),
        bead_station_3=float(config.bead_station_3),
